...
| [salon-engine-v7](salon-engine-v7.md) | in_progress | v0.7 | **MetaController**: FlowMeter 수렴도→μ 낮춰 방 식히는 거시→미시 피드백(design §4/§10). 약한 게인+floor(고착/진동 방지). content 게이팅(flow None→mu_scale 1.0→골든 보존). 로드맵 마지막·가장 조심스러운 단계. task 36~38 |
