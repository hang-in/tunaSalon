...
| [salon-engine-v6](salon-engine-v6.md) | in_progress | v0.6 | **FlowMeter**: 대화 수렴/발산을 토큰 중복으로 측정(키워드 근사, BGE-M3 이후). 관찰만(엔진 피드백 금지=v0.7). content 없으면 None→골든 보존. 채팅 사이드바 수렴/발산 게이지. task 33~35 |
